...
<x-app-layout>
    ...
    <input required type="text" name="name" id="name" class="w-full p-2 border border-gray-300 dark:border-gray-700 rounded-lg dark:bg-gray-900 dark:text-gray-300" pattern="[a-zA-Z0-9\s]+" min="0">
</div>
<div class="mb-4">
